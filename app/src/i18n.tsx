...
const es = {
  ...
  "prov.sub": "Quien piensa tu prompt. De fabrica va el Ollama de tu equipo: gratis, sin clave y sin salir de tu maquina. Encima tienes dos caminos: las herramientas que YA tienes instaladas y con sesion iniciada, que gastan de tu suscripcion y no piden clave, o un proveedor con su clave de API.",
  "prov.cli.missing": "No esta instalado en este equipo.",
  "prov.cli.model": "El modelo lo elige la propia herramienta, con la sesion que ya tienes iniciada. Aqui no hay nada que rellenar.",
  "prov.who": "Proveedor",
  "prov.base": "URL base",
