...
const es = {
  ...
  "ratio.note": "Recorta el vídeo a esa forma. NO sigue a la persona: si se sale del cuadro, muévelo tú con la barra.",
  "ratio.crop": "Recorte",
  "ratio.center": "centro",
...
const en: Record<keyof typeof es, string> = {
  ...
  "ratio.note": "Crops the video to that shape. It does NOT follow the person: if they drift out, move it yourself with the slider.",
  "ratio.crop": "Crop",
  "ratio.center": "centre",
