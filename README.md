...
[![Tests](https://img.shields.io/badge/tests-1565%20checks-00b359.svg)](tests/)
...
test_castellano.py       520 strings        every accent in the Spanish the app shows
...
test_aprende.py           43 cases          reads a video back and names its style
```
